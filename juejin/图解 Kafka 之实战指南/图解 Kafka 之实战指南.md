...
![图1-1 Kafka体系结构](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\16949bd6279df106-1584083160196)
...
![图1-2 消息追加写入](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="667"></svg>)
...
![图3-6](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\1695ab91ecc0651c)
...
![图3-7](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="469"></svg>)
...
![图3-8](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="625"></svg>)
...
![3-9](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\1695ac2e4e7fc5cf)
...
本节只是简单演示了再均衡监听器的用法，再均衡期间消费者客户端与 Kafka 服务端之间的交互逻辑及相关原理并不简单，更多的细节可以参考图解Kafka之核心原理中的相关的内容。
...
![图3-10](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="451"></svg>)
...
![3-11](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="513"></svg>)
...
![图3-12](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\1695138ead894cc1)
...
![图3-13](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\169513be4320133f)
...
从第7节至本节主要讲述了消费者和消费组的概念，以及如何正确使用 KafkaConsumer。具体的内容还包括参数配置的讲解、订阅、反序列化、位移提交、再均衡、消费者拦截器、多线程的使用。不过本章并没有同前一章的生产者一样讲述具体的原理，因为考虑到 KafkaConsumer 内部实现相对复杂，具体的原理讲述篇幅较长，故将相关的内容编排到《图解Kafka之核心原理》中，如果读者迫切地想要了解这部分的知识，可以直接跳转到《图解Kafka之核心原理》相关章节进行阅读。
...
![图4-1](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\169515b01842457b)
...
有关 Kafka 的自定义协议的更多内容可以参阅《图解Kafka之核心原理》的相关章节。
...
![4-2](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\1696356a44b9a676)
...
![4-3](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\1696357a5ab2bc03)
...
![9-1](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\169639a7f1a65e19)
...
- kafka-connect-elasticsearch（[github.com/confluentin…](https://github.com/confluentinc/kafka-connect-elasticsearch）；)
- kafka-connect-jdbc（[github.com/confluentin…](https://github.com/confluentinc/kafka-connect-jdbc）；)
- kafka-connect-hdfs（[github.com/confluentin…](https://github.com/confluentinc/kafka-connect-hdfs）；)
- kafka-connect-storage-cloud（[github.com/confluentin…](https://github.com/confluentinc/kafka-connect-storage-cloud）。)
...
![9-2](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\1696864261a97ef1)
...
![9-3](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\16968678f79fc908)
...
kafka-mirror-maker.sh 脚本对应的实现类是 kafka.tools.MirrorMaker，它只有500多行代码，很多时候我们会把它与同类产品 uReplicator 进行对比，笔者觉得这样有失稳妥，前者的定位只是一个工具，而后者是一个完备的工程项目，它们都有各自的适用场景。不过话又说回来，uReplicator 底层也是基于 MirrorMaker 进行构建的，并针对 MirrorMaker 做了大量的调优及工程化改造，具体的内容可以参考官网介绍：[eng.uber.com/ureplicator…](http://eng.uber.com/ureplicator/。)
...
从第27节到这里我们主要介绍 Kafka 现有的几个应用工具，对一般用户而言，这些应用工具已经足够应对大多数的场景。不过，我们还可以利用 Kafka 现有的特性和功能来扩展一些高级应用，比如延时（迟）队列、重试队列等，读者可以在《图解 Kafka 之实战指南》中查阅相关的内容。
...
![10-1](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\169687c711faa8ce)
...
![10-2](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\169687cee7bc9e39)
...
![10-3](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="669" height="238"></svg>)
...
![10-4](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="744"></svg>)
...
![10-5](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\1696886e14027f5f)
...
由定义可知，OneMinuteRate 是一种指数加权移动平均值（学术上简称为[EWMA](https://en.wikipedia.org/wiki/EWMA_chart)）。在 Yammer Metrics 中关于 OneMinuteRate 的实现细节如下。 首先定义 alpha 的值：
...
![10-6](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="286"></svg>)
...
![10-7](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\169689507ad50500)
...
![10-8](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\16968963d41fd445)
...
![10-9](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="272" height="275"></svg>)
...
![10-10](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="302" height="222"></svg>)
...
![10-11](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1242" height="750"></svg>)
...
![10-12](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="1063"></svg>)
...
![12-1](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\1696d7247b7ec1bc)
...
![12-2](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="849"></svg>)
...
![12-3](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="580"></svg>)
...
![12-4](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\1696d8978a5d96bb)
...
![12-5](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\1696d8a440f10fc7)
...
![12-6](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1272" height="366"></svg>)
...
![12-7](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="506"></svg>)
...
![12-8](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="539"></svg>)
...
![12-9](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1168" height="730"></svg>)
...
![12-10](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1154" height="592"></svg>)
...
![12-11](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\1696da264b02e51b)
...
![12-12](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\1696da631d0cee39)
...
![12-13](D:\data\work\mdword\juejin\图解 Kafka 之实战指南\upload\1696dbce41d7a18c)
